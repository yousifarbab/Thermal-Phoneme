# ============================================================
# 🔥 Thermal-Phoneme: الواجهة الرئيسية (main_app.py)
# ============================================================
# هذا التطبيق هو الواجهة التفاعلية للمشروع الثوري.
# يعرض قدرات التشفير بالحروف العربية، والمحاكاة الحرارية،
# وتحليل الإشارات، وخريطة التوزيع الحراري.
# ============================================================
...
with tab2:
    ...
    with col1:
        ...
        if st.button("🚀 محاكاة الإرسال", key="simulate_btn"):
            ...
            # حساب قوة الإشارة بعد التضعيف
            attenuated_power = power * attenuation
            
            # توليد إشارة حرارية محاكاة
            time_steps = 100
            signal = []
            for i in range(time_steps):
                # إشارة مركبة من عدة ترددات
                value = 0
                for j, freq in enumerate(frequencies[:5]):  # حد أقصى 5 ترددات للوضوح
                    if freq > 0:
...
with tab3:
    ...
    with col1:
        ...
        # إضافة خطوط عمودية للترددات المميزة
        for letter, freq in PHONEME_MAP.items():
...
with tab4:
    ...
    with col1:
        ...
        # توليد خريطة حرارية وهمية
        x = np.linspace(-10, 10, 100)
        y = np.linspace(-10, 10, 100)
        X, Y = np.meshgrid(x, y)
        
        # محاكاة توزيع الإشارة (مركز في (2, 3) مع توهج)
